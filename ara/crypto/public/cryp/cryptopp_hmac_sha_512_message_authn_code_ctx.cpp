...
namespace ara
{
    namespace crypto
    {
        namespace cryp
        {    
            const std::string CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::mAlgName("hmac_sha_512");
            
            /********************** constructor **************************/
                
            CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx():
                                                            mKey(nullptr),
            ...
            CryptoPrimitiveId::Uptr CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::GetCryptoPrimitiveId () const noexcept
            {
                return std::make_unique<CryptoPP_CryptoPrimitiveId>(mPId);
            }

            bool CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::IsInitialized () const noexcept
            {
            ...
            ara::core::Result<void> CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::SetKey ( const SymmetricKey &key, 
                                                CryptoTransform transform) noexcept
            {
                ...
                try
                {
                    const CryptoPP_HMAC_SHA_512_SymmetricKey& aesKey = dynamic_cast<const CryptoPP_HMAC_SHA_512_SymmetricKey&>(key);
                    mKey = new CryptoPP_HMAC_SHA_512_SymmetricKey(aesKey);
            ...
            ara::core::Result<void> CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::Start (ReadOnlyMemRegion iv) noexcept
            {
            ...
            // ara::core::Result<void> CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::Start (const SecretSeed &iv) noexcept=0;

            /*
            ara::core::Result<void> CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::Update (const RestrictedUseObject &in) noexcept
            {

            }
            */

            ara::core::Result<void> CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::Update (ReadOnlyMemRegion in) noexcept
            {
            ...
            ara::core::Result<void> CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::Update (std::uint8_t in) noexcept
            {
            ...
            ara::core::Result<Signature::Uptrc> CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::Finish (bool makeSignatureObject) noexcept
            {
                if(seq == helper::calling::START_IS_NOT_CALLED) // return error
                {
                ...
                else if(seq == helper::calling::UPDATE_IS_CALLED)
                {
                    ...
                    {
                        auto signature = std::make_unique<CryptoPP_HMAC_SHA512_Signature>();
                        signature->setValue(digest);
                        
                        return ara::core::Result<CryptoPP_HMAC_SHA512_Signature::Uptrc>::FromValue(std::move(signature));
                    }
                    else
                        return ara::core::Result<CryptoPP_HMAC_SHA512_Signature::Uptrc>::FromValue(nullptr);
                }
            ...
            ara::core::Result<ara::core::Vector<ara::core::Byte> > CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::GetDigest (std::size_t offset) const noexcept
            {
            ...
            ara::core::Result<bool> CryptoPP_HMAC_SHA_512_MessageAuthnCodeCtx::Check (const Signature &expected) const noexcept
            {
                try
                {
                    const CryptoPP_HMAC_SHA512_Signature& sign = dynamic_cast<const CryptoPP_HMAC_SHA512_Signature&>(expected);

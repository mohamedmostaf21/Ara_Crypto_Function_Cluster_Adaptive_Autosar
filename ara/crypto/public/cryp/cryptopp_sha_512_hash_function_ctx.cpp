...
namespace ara
{
    namespace crypto
    {
        ...
        {    
            ...
            const std::string CryptoPP_SHA_512_HashFunctionCtx::mAlgName("sha_512");

            /********************** constructor **************************/
            CryptoPP_SHA_512_HashFunctionCtx::CryptoPP_SHA_512_HashFunctionCtx(): HashFunctionCtx(),
            ...
            CryptoPrimitiveId::Uptr CryptoPP_SHA_512_HashFunctionCtx::GetCryptoPrimitiveId () const noexcept
            {
                return std::make_unique<CryptoPP_CryptoPrimitiveId>(mPId);
            }
            
            bool CryptoPP_SHA_512_HashFunctionCtx::IsInitialized () const noexcept
            {
                return true;
            }
            ...
            ara::core::Result<void> CryptoPP_SHA_512_HashFunctionCtx::Start (ReadOnlyMemRegion iv) noexcept
            {
            ...
            ara::core::Result<void> CryptoPP_SHA_512_HashFunctionCtx::Start () noexcept
            {
            ...
            ara::core::Result<void> CryptoPP_SHA_512_HashFunctionCtx::Update (ReadOnlyMemRegion in) noexcept
            {  
            ...
            ara::core::Result<void> CryptoPP_SHA_512_HashFunctionCtx::Update (std::uint8_t in) noexcept
            {
                if(seq == calling::START_IS_NOT_CALLED)
                {
                    ara::core::ErrorCode x =  ara::crypto::MakeErrorCode(CryptoErrorDomain::Errc::kProcessingNotStarted,5); 
            ...
            ara::core::Result<ara::core::Vector<ara::core::Byte>> CryptoPP_SHA_512_HashFunctionCtx::Finish() noexcept
            {
                if(seq == calling::START_IS_NOT_CALLED)
                {
                    ara::core::ErrorCode x =  ara::crypto::MakeErrorCode(CryptoErrorDomain::Errc::kProcessingNotStarted,5); 
            ...
            ara::core::Result<ara::core::Vector<ara::core::Byte>> CryptoPP_SHA_512_HashFunctionCtx::GetDigest (std::size_t offset) noexcept
            {

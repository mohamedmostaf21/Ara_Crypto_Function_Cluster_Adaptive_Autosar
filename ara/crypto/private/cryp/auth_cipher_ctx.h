    ...
    namespace crypto{
        namespace cryp{
            ...
            public:
                ...
                //                                                         ara::core::Optional<ReadOnlyMemRegion> expectedTag
                //                                                     )noexcept=0;
                  virtual ara::core::Result<void> SetTransformation(CryptoTransform transform)  noexcept=0;
                ...
                virtual bool VerifyTag(const core::Span<const unsigned char>& expectedTag) noexcept=0;
                virtual std::string ToString(const CryptoTransform& transform) const  noexcept=0;
            };
        }
    }
}
